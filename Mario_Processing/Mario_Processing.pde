...
void setup() {
  ...
  for (int x=0; x<MarioJumpRight.width; x++) {
    for (int y=0; y<MarioJumpRight.height; y++) {
  ...
  Goomba1.loadPixels();
  for (int x=0; x<Goomba1.width; x++) {
    for (int y=0; y<Goomba1.height; y++) {
  ...
  Goomba2.loadPixels();
  for (int x=0; x<Goomba2.width; x++) {
    for (int y=0; y<Goomba2.height; y++) {
